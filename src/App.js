...
import correctBgm from "./assets/audios/correct.mp3";
import gameoverBgm from "./assets/audios/gameover.mp3";
import gameBgm from "./assets/audios/happy.mp3";
...
class App extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    const { currentWord, typedValue, plusScore, score, timerBase, audioMuted } = this.state;
  ...
  render() {
    const { gameStarted, gameOver, audioMuted, isLoaded, countdownFinished } = this.state;
      ...
      <React.Fragment>
        {isLoaded ? (
          <div className={isLoaded ? "beater fadeIn" : "beater"}>
            ...
            {gameStarted && !countdownFinished && <Countdowm initTimer={this.initTimer} />}
            ...
            {gameOver && (
              <GameOver gameData={this.state} initGame={this.initGame} quitGame={this.quitGame} />
            )}
            {!gameStarted && !gameOver && <MainScreen initGame={this.initGame} />}
          </div>
        ) : (
          <Loader />
        )}
